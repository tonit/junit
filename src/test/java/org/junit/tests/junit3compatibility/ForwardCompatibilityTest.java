...
public class ForwardCompatibilityTest extends TestCase {
	...
	public void testToString() {
		...
		assertEquals(String.format("test(%s)", NewTest.class.getName()), test
				.toString());
	}
	...
	public void testInvalidMethod() {
		...
		assertTrue(failure.exceptionMessage().contains(
				"Method shouldBeStatic() should be static"));
	}
